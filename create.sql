...
create table tb_seller (id int8 generated by default as identity, email varchar(255), name varchar(255), phone varchar(255), primary key (id));
alter table if exists tb_sales add constraint FK83y0efee0lgf3g48lqjg8ci4d foreign key (seller_id) references tb_seller;
